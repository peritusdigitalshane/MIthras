...
const NotFound = () => {
  ...
  return (
    <>
      <Seo
        title="Page not found — Mithras Threat Defence"
        description="The page you were after does not exist on Mithras Threat Defence. Try the home page or the blog."
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-background via-background to-muted/30 p-6">
        <div className="max-w-md w-full bg-card border rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Still stuck? <Link to="/blog" className="underline">Read the blog</Link>
            {" "}or{" "}
